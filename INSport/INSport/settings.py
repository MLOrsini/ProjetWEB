"""
Django settings for INSport project.
...
SECRET_KEY = '8wr_8*(n^9&!0fvdhn$kj^ec0#*x6d1861_+^3pc*(6=@zdvgt'
...
WSGI_APPLICATION = 'INSport.wsgi.application'
